...
// === API Configuration ===
// (Consider moving token to a settings page for security in the future!)
// define( 'WJB_API_TOKEN', 'f7N96tHVniZSr4fa0k9M0L4ScTa8U4S8QaOf6sqZ__A' );
// define( 'WJB_WORKABLE_SUBDOMAIN', 'tcp-software-1' );
